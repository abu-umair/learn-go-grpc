...
type User struct {
	...
	Id    int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	// string full_name = 2;
	Age           int64                  `protobuf:"varint,3,opt,name=age,proto3" json:"age,omitempty"` //ingin validasi nilainya tidak boleh negatif
	...
	Educations    []string               `protobuf:"bytes,7,rep,name=educations,proto3" json:"educations,omitempty"` //['SMA', 'D2', 'D3'], ['S1', 'S2', 'S3']
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x04city\x18\x04 \x01(\tR\x04city\"\x93\x02\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x19\n" +
	"\x03age\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x03age\x12\x18\n" +
